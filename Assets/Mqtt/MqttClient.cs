...
namespace uPLibrary.Networking.M2Mqtt
{
    ...
    public class MqttClient
    {
...
#endif
        /// <summary>
        /// Delegate that defines event handler for client connected
        /// </summary>
        public delegate void MqttConnectedEventHandler(object sender);
        ...
        // event for client disconnection (DISCONNECT message or not)
        public event MqttConnectedEventHandler MqttConnected;
