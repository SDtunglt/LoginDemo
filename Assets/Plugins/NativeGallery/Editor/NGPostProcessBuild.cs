...
namespace NativeGalleryNamespace
{
	public class NGPostProcessBuild
	{
		...
		private const string PHOTO_LIBRARY_USAGE_DESCRIPTION = "The app requires access to Photos so that you can upload your own avatar.";
		private const string PHOTO_LIBRARY_ADDITIONS_USAGE_DESCRIPTION = "The app would like to access your Photos to save your in-game screenshots.";
